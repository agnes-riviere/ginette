#LIBRARY
#---- First nterpolate timeseries to match the time discretization ----
library(stats) #for spline interpolation
library(lubridate)
library(stringr)
#---- Then plots the data to check that it's correct ----
library(ggplot2)
library(stringr)
...
# Create a data-frame with all HZ temperature from the PT100
for (i in 1:nPT100)  {
