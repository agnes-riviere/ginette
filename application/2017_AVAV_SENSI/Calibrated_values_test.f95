      ...
      write(2,20)k(1),n(1),l(1),r(1),as(1),ans(1),swres(1),&
     k(2),n(2),l(2),r(2),as(2),ans(2),swres(2),&
     k(3),n(3),l(3),r(3),as(3),ans(3),swres(3),&
     k(4),n(4),l(4),r(4),as(4),ans(4),swres(4),&
     k(5),n(5),l(5),r(5),as(5),ans(5),swres(5)
