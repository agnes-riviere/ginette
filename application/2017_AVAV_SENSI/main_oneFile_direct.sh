...
line6=$(sed -n '6p' < E_zone_parameter.dat) # zone 6
line7=$(sed -n '7p' < E_zone_parameter.dat) # zone 7
line8=$(sed -n '8p' < E_zone_parameter.dat) # zone 8
